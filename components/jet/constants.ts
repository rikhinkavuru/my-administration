...
export const FLIGHT = {
  ...
  //     diagonal sweep.
  // 6° descent from upper-left to lower-right.
  // X range -10..+10 (= 20 units) -> drop = 20 * tan(6°) ≈ 2.102 scene units.
  // Path remains in the upper band -> middle band of the viewport.
  Y_START: 1,
  Y_END: -1.102,
